...
public class Archivo {
    public static void main(String[] args) {
        File archivo = new File("/Users/rafamtz/Library/CloudStorage/GoogleDrive-ramartinezr@tec.mx/Mi unidad/Personal/BecasSantander/BeduJavaWeb/Fase1/gitfase1/Sesion-08/temp/cursos/cursos.txt");
